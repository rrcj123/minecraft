    ...
    <div>
        <div class="box">
            <form enctype="multipart/form-data" method="post" action="https://worldht.rrcj123.com/shangchuan" target="nm_iframe" id="_from">
                ...
                图片标题：<input type="text" style="width: 200px;margin-bottom:10px;" v-model="title" name="title"/><span style="font-size: 12px;padding-left: 20px;color: #999">不是文件名哦</span><br/>
                <!-- 仅仅在使用multer。array时候 -->
                ...
                <input type="button" value="上传" @click="getip()" style="width:100px;height:35px;" />
            </form>
